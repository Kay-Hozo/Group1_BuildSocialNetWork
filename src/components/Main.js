...
class Main extends Component {
  isVote(address,id){
    let result = false
    try {
      result = this.props.socialNetwork.methods.addressVotes(address,id).call()
      return result;
    } catch (error) {
                      ...
                      <li key={key}  className="list-group-item py-2">
                        ...
                        >   
                           ...
                           <svg  version="1.0" width="20" height="20" viewBox="0 0 300.000000 300.000000" preserveAspectRatio="xMidYMid meet">
                            <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)" fill={this.isVote(this.props.account,key+1) ? "red" :"black"} stroke="none">
                           ...
                           <span>{parseInt(post.vote._hex.split('0x')[1],16)}</span>
                        </button>
